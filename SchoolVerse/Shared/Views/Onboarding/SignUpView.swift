...
struct SignUpView: View {
    ...
    @State var details: UserModel = UserModel(userId: "", displayName: "", gradeLevel: 9, email: "", courses: [], subscribedSports: [], joinedClubs: [], approved: false)
                        ...
                        HStack (spacing: 10) {
                            ForEach (9..<13) { grade in
                                Text("Grade \(grade)")
                                    ...
                                    .if(UIDevice.current.userInterfaceIdiom == .pad) { view in
                                        view
                                            .frame(width: UIScreen.main.bounds.width / 5.25)
                                    }
                                    .background (
                                        ZStack {
